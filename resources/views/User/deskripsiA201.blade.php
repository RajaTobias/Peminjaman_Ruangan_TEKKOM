...
@section('content')
          ...
          <div class="portfolio">
            ...
            <div class="row1">
                ...
                <div class="containerp">
                    ...
                    <form class="druangan">
                        <p class="teksr1">Ruang 201</p>
                        <p class="teksf1">Fasilitas :</p>
                        <p class="teksf2"> <i class='bx bx-chair icon' ></i>  121 Kursi Meja</p>
                        ...
                        <p class="teksf8"> <i class='bx bx-chalkboard icon' ></i>  4 AC</p>
                        ...
                        <p class="teksf7"> <i class='bx bx-male-female icon' ></i>  Orang</p>
                                ...
                                <div class="cardy">
                                    <a href="{{ route('User.A201') }}" class="borderdr">Pinjam Ruangan <i class='bx bx-chevron-right icon'> </i> </a>
                                </div>
                    </form>
            </div>
    ...
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/201a.jpg') }}" alt="Image 1">
        </a>
    </div>
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/201b.jpg') }}" alt="Image 2">
        </a>            
    </div>
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/201c.jpg') }}" alt="Image 3">
        </a>            
    </div>
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/201d.jpg') }}" alt="Image 4">
        </a>
    </div>
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/201e.jpg') }}" alt="Image 5">
        </a>            
    </div>
