...
@section('content')
          ...
          <div class="portfolio">
            ...
            <div class="row1">
                ...
                <div class="containerp">
                    ...
                    <form class="druangan">
                        <p class="teksr1">Lab. Mulmed</p>
                        <p class="teksf1">Fasilitas :</p>
                        <p class="teksf2"> <i class='bx bx-chair icon' ></i>  23 Kursi Meja</p>
                        ...
                        <p class="teksf7"> <i class='bx bx-male-female icon' ></i>  Orang</p>
                                ...
                                <div class="cardy">
                                    <a href="{{ route('User.labmulmed') }}" class="borderdr">Pinjam Ruangan <i class='bx bx-chevron-right icon'> </i> </a>
                                </div>
                    </form>
            </div>
    ...
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/mlda.jpg') }}" alt="Image 1">
        </a>
    </div>
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/mldb.jpg') }}" alt="Image 2">
        </a>            
    </div>
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/mldc.jpg') }}" alt="Image 3">
        </a>            
    </div>
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/mldd.jpg') }}" alt="Image 4">
        </a>
    </div>
