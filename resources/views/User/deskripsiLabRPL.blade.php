...
@section('content')
                ...
                <div class="containerp">
                    ...
                    <form class="druangan">
                        ...
                        <p class="teksf7"> <i class='bx bx-male-female icon' ></i>  Orang</p>
                                ...
                                <div class="cardy">
                                    <a href="{{ route('User.labrpl') }}" class="borderdr">Pinjam Ruangan <i class='bx bx-chevron-right icon'> </i> </a>
                                </div>
                    </form>
            </div>
    ...
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/rplc.jpg') }}" alt="Image 1">
        </a>            
    </div>
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/rpld.jpg') }}" alt="Image 2">
        </a>
    </div>
    <div>
        <a href="#">
            <img src="{{ asset('assets/img/rple.jpg') }}" alt="Image 3">
        </a>            
    </div>
